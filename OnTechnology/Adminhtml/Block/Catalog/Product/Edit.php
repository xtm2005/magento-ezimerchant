 ...
 */
class OnTechnology_Adminhtml_Block_Catalog_Product_Edit extends Mage_Adminhtml_Block_Catalog_Product_Edit
{
    ...
    {
		/*echo '<pre>';
		print_r(Mage::registry('current_product'));exit;*/
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getRequest()->getParam('popup')) {
			...
			if ($this->getProduct()) {
                ...
                $this->getLayout()->createBlock('adminhtml/widget_button')
                    ->setData(array(
                        'label'     => Mage::helper('catalog')->__('Sync Ezi'),
                        'onclick'   => 'addtoeziproduct.open(\''. $this->getSyncUrl() .'\')'
                    ))
                );
            }
        }
    ...
    {
        return $this->getUrl('*/*/addproducttoezi', array('_current'=>true));
    }
